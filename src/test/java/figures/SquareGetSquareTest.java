...
public class SquareGetSquareTest {
    @Test
    ...
    public void firstPerimeterTest(){
        ...
        then(String.format("%.2f", Double.parseDouble(square.getSquare()))).isEqualTo("1,00");
    }
    ...
    public void secondPerimeterTest(){
        ...
        then(String.format("%.2f", Double.parseDouble(square.getSquare()))).isEqualTo("9,00");
    }
